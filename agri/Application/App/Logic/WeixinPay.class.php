...
class WeixinPay {
    ...
    private function unifiedorder() {
        $url = 'https://api.mch.weixin.qq.com/pay/unifiedorder';//统一的
        $parameters = array(
            'appid' => $this->appid, //小程序ID
            ...
            'notify_url' => 'http://'.$_SERVER['HTTP_HOST'].'app.php/WeixinPay/callback', //通知地址  确保外网能正常访问
